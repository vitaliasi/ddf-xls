...
Methods to add info and leave are written, but were not executed due to locked OrangeHRM DB.
All sheets/data which was planned to use could be found in .xls file.
